                            ...
                            <div class="col-lg-16">
                                <div class="p-20 m-b-20">
                                    <div class="encabezados">
                                        <h2><span class="glyphicon glyphicon-usd" aria-hidden="true"></span> Compras</h2>
                                    </div>
                                    <div align="right">
                                            ...
                                            <div class="table-responsive">
                                                <table id="datatable-keytable" class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $comp[5]?></td>
                        <td>
                        <a class="btn btn-icon btn-primary" type="button" data-toggle="modal" data-target="#ver" onclick="agregaCompra('<?php echo $datos ?>')">
                ...
                <div class="modal-content">
                    ...
                    <?php
                        if(isset($_POST['guardar'])){
                            conectar();
                            require ("registrar/registrarCompra.php");
                            desconectar();
                        }
                    ?>
            </div>
                ...
                <div class="modal-content">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Producto</label>
                                <input type="text" hidden="" id="idCompra" name="">
