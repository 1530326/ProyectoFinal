                            ...
                            <div class="col-lg-16">
                                <div class="p-20 m-b-20">
                                    <div class="encabezados">
                                        <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Proveedores</h2>
                                    </div>
                                    <div align="right">
                                            ...
                                            <div class="table-responsive">
                                                <table id="datatable-keytable" class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $pro[2], ' ', $pro[3], ' ', $pro[4], ' ', $pro[5]?></td>
                                                        <td><?php echo $pro[6]?></td>
                                                        <td><?php echo $pro[7]?></td>
                        <td><a class="btn btn-icon btn-primary" type="button" data-toggle="modal" data-target="#modificar" onclick="agregaProveedor('<?php echo $datos ?>')">
				        <span class="fa fa-wrench" aria-hidden="true"></span></a> 
				        <a class="btn btn-icon btn-danger" onclick="preguntarSiNoProveedor('<?php echo $pro[0] ?>')"><span class="fa fa-remove" aria-hidden="true"></span></a></td>
                                                    </tr>
                                                    <?php endforeach ?> 
                                                    </tbody>
                                                </table>
                ...
                <div class="modal-content">
                    ...
                    <?php
                        if(isset($_POST['guardar'])){
                            conectar();
                            require ("registrar/registrarProveedor.php");
                            desconectar();
                        }
                    ?>
            </div>
